...
// Code to manage students goes here
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><a href='edit-student.php?id=" . $row['id'] . "'>Edit</a> | <a href='delete-student.php?id=" . $row['id'] . "' onclick='return confirm(\"Are you sure?\")'>Delete</a></td>";
                            echo "</tr>";
                        }
                    } else {
